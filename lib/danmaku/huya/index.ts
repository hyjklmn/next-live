...
const userAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/91.0.4472.69"
export default class DouYuDanmaku extends Client {
  ...
  async getChatInfo(): Promise<ChatInfo> {
    const t = await fetch(`/mhy/${this.room_id}`, {
      headers: {
